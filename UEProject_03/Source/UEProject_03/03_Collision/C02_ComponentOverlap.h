...
UCLASS()
class UEPROJECT_03_API AC02_ComponentOverlap : public AActor
{
	GENERATED_BODY()
...
private:
	UFUNCTION()
		void OnComponenetBeginOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, 
