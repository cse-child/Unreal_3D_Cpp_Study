...
void AC02_ComponentOverlap::BeginPlay()
{
	...
	Box->OnComponentBeginOverlap.AddDynamic(this, &AC02_ComponentOverlap::OnComponenetBeginOverlap);
	Box->OnComponentEndOverlap.AddDynamic(this, &AC02_ComponentOverlap::OnComponentEndOverlap);
	
}

void AC02_ComponentOverlap::OnComponenetBeginOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor,
