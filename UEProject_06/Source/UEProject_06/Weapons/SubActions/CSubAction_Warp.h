...
class UEPROJECT_06_API UCSubAction_Warp : public UCSubAction
{
	GENERATED_BODY()
...
private:
	...
	UPROPERTY(EditDefaultsOnly, Category = "Camera")
		FVector CameraRelativeLocation; // 지면과의 카메라 간격

	// Projection Mode는 Perspective(원근투영)와 Orthographic(직교투영)
	UPROPERTY(EditDefaultsOnly, Category = "Camera")
		TEnumAsByte<ECameraProjectionMode::Type> ProjectionMode;

	/* Camera Component Args */
	UPROPERTY(EditDefaultsOnly, Category = "Camera")
