...
void AC03_OverlapAndHit::BeginPlay()
{
	...
	Box->OnComponentBeginOverlap.AddDynamic(this, &AC03_OverlapAndHit::OnComponenetBeginOverlap);
...
void AC03_OverlapAndHit::OnComponenetBeginOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor,
